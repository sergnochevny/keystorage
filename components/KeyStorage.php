<?php
namespace sn\keystorage\components;
...
class KeyStorage extends Component
{
     ...
     * @var string
     */
    public $modelClass = 'sn\keystorage\models\KeyStorage';
    ...
    public function init()
    {
        ...
        if (!isset(Yii::$app->i18n->translations['keyStorage'])) {
    ...
    protected function getModel($key)
    {
        ...
        return $query->where(['name'=>$key])->select(['name', 'value'])->one();
    }
